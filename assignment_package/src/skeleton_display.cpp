//#include "skeleton_display.h"

//SkeletonDisplay::SkeletonDisplay(OpenGLContext *context) : Drawable(context), skeleton_to_disp(nullptr) {};

//void SkeletonDisplay::create()
//{
//    std::vector<glm::vec4> color; // the color to be displayed for this Skeleton
//    std::vector<glm::vec4> position; // the color to be displayed for this Skeleton
//    std::vector<GLint> idx;

//    color.push_back(glm::vec4{1,1,1,1});
//    position.push_back(glm::vec4(skeleton_to_disp->pos, 1));
//    idx.push_back(0);
...
//void SkeletonDisplay::updateSkeleton(Skeleton* skelly)
//{
//    this->skeleton_to_disp = skelly;
//}
